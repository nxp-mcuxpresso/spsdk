...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0, 4096, False, SectionsContent.SIMPLE, 0x80000000),  # SB2.0 signed simple, 4096 key length
        (0, 2048, True, SectionsContent.SIMPLE, 0x8001000),  # SB2.0 OTFAD simple
        (1, 2048, False, SectionsContent.SIMPLE, 0x80000000),  # SB2.1 signed simple, 2048 key length
        (1, 4096, False, SectionsContent.SIMPLE, 0x80000000),  # SB2.1 signed simple, 4096 key length
...
def test_sb2_0_builder_validation(data_dir):
    ...
    # create boot image
    boot_image = BootImageV20(True, kek=kek_value, product_version='1.0.0', component_version='1.0.0', build_number=1)
