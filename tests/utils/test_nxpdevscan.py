...
def test_usb_device_search():
    ...
    """
    test_vector = [
        {"vendor_id": 0x0001, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x15, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x1fc9, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x15a2, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
    ]
    result = [
...
def test_usb_device_search_extended():
    ...
    test_vector = [
        ...
        {"vendor_id": 0x15, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x1fc9, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x0002, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
        {"vendor_id": 0x15a2, "product_id": 0, "path": b"", "manufacturer_string": "", "product_string": ""},
    ]
    result = [
        devicedescription.USBDeviceDescription(0x1fc9, 0, "", "", "", ""),
...
list_port_info_mock = [ListPortInfo(device="COM1"), ListPortInfo(device="COM5"), ListPortInfo(device="COM28")]
...
def test_path_conversion():
    ...
    with patch('platform.system', MagicMock(return_value="Windows")):
        win_path = b'\\\\?\\hid#vid_1fc9&pid_0130#6&1625c75b&0&0000#{4d1e55b2-f16f-11cf-88cb-001111000030}'
        assert devicedescription.convert_usb_path(win_path) == 'HID\\VID_1FC9&PID_0130\\6&1625C75B&0&0000'
    ...
    with patch('platform.system', MagicMock(return_value="Darwin")):
        ...
        assert devicedescription.convert_usb_path(mac_path) == "IOService:/AppleACPIPlatformExpert/PCI0@0/AppleACPIPCI/XHC1@14/XHC1@14000000/HS02@14200000/SE Blank RT Family @14200000"
