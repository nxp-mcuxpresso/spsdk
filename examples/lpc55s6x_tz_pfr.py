...
from spsdk.pfr.pfr import CFPA, PfrConfiguration
...
def generate_trustzone() -> None:
    ...
    with open(os.path.join(DATA_DIR, "lpc55s6x_tz.json")) as config_file:
        config_data = json.load(config_file)

    tz_presets = TrustZone.custom(family="lpc55s6x", customizations=config_data)
