...
import os
from os import path
from spsdk.crypto.keys_management import generate_rsa_private_key, generate_rsa_public_key, save_private_key, \
    save_public_key, Encoding
...
def main() -> None:
    ...
    save_private_key(priv_key_2048, path.join(data_dir, "ca_privatekey_rsa2048.pem"))
    save_public_key(pub_key_2048, path.join(data_dir, "ca_publickey_rsa2048.pem"))
    ...
    priv_key_2048 = generate_rsa_private_key(key_size=2048)
    pub_key_2048 = generate_rsa_public_key(priv_key_2048)
    save_private_key(priv_key_2048, path.join(data_dir, "crt_privatekey_rsa2048.pem"))
    save_public_key(pub_key_2048, path.join(data_dir, "crt_publickey_rsa2048.pem"))
    print("The pair of private (crt_privatekey_rsa2048.pem) and public (crt_publickey_rsa2048.pem) key was generated.")
    # Generate and save rsa keys (size 2048) - pem format (for usage of chain of certificate)
    priv_key_2048 = generate_rsa_private_key(key_size=2048)
    pub_key_2048 = generate_rsa_public_key(priv_key_2048)
    save_private_key(priv_key_2048, path.join(data_dir, "chain_privatekey_rsa2048.pem"))
    save_public_key(pub_key_2048, path.join(data_dir, "chain_publickey_rsa2048.pem"))
    print("The pair of private (chain_privatekey_rsa2048.pem) and public (chain_publickey_rsa2048.pem) key was "
          "generated.")
    # Generate and save rsa keys (size 2048) - pem format (for usage of chain of certificate)
    priv_key_2048 = generate_rsa_private_key(key_size=2048)
    pub_key_2048 = generate_rsa_public_key(priv_key_2048)
    save_private_key(priv_key_2048, path.join(data_dir, "chain_crt2_privatekey_rsa2048.pem"))
    save_public_key(pub_key_2048, path.join(data_dir, "chain_crt2_publickey_rsa2048.pem"))
    ...
    save_private_key(priv_key_3072, path.join(data_dir, "private_rsa3072.pem"))
    save_public_key(pub_key_3072, path.join(data_dir, "public_rsa3072.pem"))
    ...
    save_private_key(priv_key_4096, path.join(data_dir, "private_rsa4096.pem"))
    save_public_key(pub_key_4096, path.join(data_dir, "public_rsa4096.pem"))
    ...
    priv_key_2048 = generate_rsa_private_key(key_size=2048)
    pub_key_2048 = generate_rsa_public_key(priv_key_2048)
    save_private_key(priv_key_2048, path.join(data_dir, "private_rsa2048.der"), encoding=Encoding.DER)
    save_public_key(pub_key_2048, path.join(data_dir, "public_rsa2048.der"), encoding=Encoding.DER)
    ...
    priv_key_3072 = generate_rsa_private_key(key_size=3072)
    pub_key_3072 = generate_rsa_public_key(priv_key_3072)
    save_private_key(priv_key_3072, path.join(data_dir, "private_rsa3072.der"), encoding=Encoding.DER)
    save_public_key(pub_key_3072, path.join(data_dir, "public_rsa3072.der"), encoding=Encoding.DER)
    ...
    priv_key_4096 = generate_rsa_private_key(key_size=4096)
    pub_key_4096 = generate_rsa_public_key(priv_key_4096)
    save_private_key(priv_key_4096, path.join(data_dir, "private_rsa4096.der"), encoding=Encoding.DER)
    save_public_key(pub_key_4096, path.join(data_dir, "public_rsa4096.der"), encoding=Encoding.DER)
